...
**Warning: Untested as of yet. Use a Claude Project to scan for enviromental variables needed and generate instructions.
           This version is idle for the moment, but Claude commentted at end that is was fully AWS Lambda ready.
           Non-Eviromental Configuration information is located in config.py and the config folder.
---
