"""
gateway/wrappers/__init__.py - Gateway Wrappers Package
Version: 2025-12-13_1
Purpose: Central import point for all gateway wrapper functions
License: Apache 2.0

This module provides convenience wrapper functions for all 14 LEE interfaces.
All wrappers delegate to gateway_core.execute_operation() following SUGA pattern.
"""
...
__all__ = [
    ...
    # SINGLETON interface (17 functions)
    'singleton_get',
    'singleton_set',
    'singleton_register',
    'singleton_has',
