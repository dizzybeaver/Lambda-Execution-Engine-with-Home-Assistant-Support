...
# Implementations are in network.http_client_core
...
def http_request(**kwargs) -> Dict[str, Any]:
    ...
    """
    from network.http_client_core import http_request_implementation
...
def http_get(**kwargs) -> Dict[str, Any]:
    ...
    """
    from network.http_client_core import http_get_implementation
...
def http_post(**kwargs) -> Dict[str, Any]:
    ...
    """
    from network.http_client_core import http_post_implementation
...
def http_put(**kwargs) -> Dict[str, Any]:
    ...
    """
    from network.http_client_core import http_put_implementation
...
def http_delete(**kwargs) -> Dict[str, Any]:
    ...
    """
    from network.http_client_core import http_delete_implementation
...
def get_http_client():
    ...
    from network.http_client_core import get_http_client
    return get_http_client()


def configure_retry(**kwargs) -> Dict[str, Any]:
    """Configure HTTP retry behavior."""
    from network.http_client_state import configure_http_retry
    return configure_http_retry(**kwargs)


def get_statistics() -> Dict[str, Any]:
    """Get HTTP client statistics."""
    from network.http_client_state import get_connection_statistics
